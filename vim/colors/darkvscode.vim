...
let s:cdTabCurrent = {'gui': '#080808', 'cterm': s:cterm00, 'cterm256': '232'}
let s:cdTabOther = {'gui': '#2D2D2D', 'cterm': s:cterm00, 'cterm256': '236'}
...
let s:cdCyan3 = {'gui': '#00d7af', 'cterm': s:cterm0C, 'cterm256': '43'}
...
call <sid>hi('userType', s:cdCyan3, {}, 'none', {})
